...
#define DEVICE_NAME                                                            \
    "NRF_EPD" /**< Name of device. Will be included in the advertising data.   \
               */
...
#define MIN_CONN_INTERVAL                                                      \
    MSEC_TO_UNITS(7.5,                                                         \
                  UNIT_1_25_MS) /**< Minimum connection interval (7.5 ms) */
...
#define CONN_SUP_TIMEOUT                                                       \
    MSEC_TO_UNITS(430,                                                         \
                  UNIT_10_MS) /**< Connection supervisory timeout (430 ms). */
...
static void gap_params_init(void) {
    ...
    snprintf(device_name, 20, "%s_%02X%02X", DEVICE_NAME, addr.addr[1],
             addr.addr[0]);
